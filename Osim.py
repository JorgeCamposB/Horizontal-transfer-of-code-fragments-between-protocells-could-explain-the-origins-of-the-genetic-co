...
class Sim:
    ...
    def run(self,reloadFlag=False):
        ...
        for g in range(0,self.params['maxTransmissions']):
            ...
            #Promote the learner to a speaker
            ...
            #self.exportHydrophobicCodonFreq('HydrophobicFreqTables\\'+str(self.params['randomSeed'])+'GenN'+str(g)+'.hft')
            #self.exportClassCodonFreq('ClassFreqTables\\GenN'+str(g)+'.cft')
            ...
            #self.learner.plotNetwork('Learner',self.transferNumber)            
            del self.speaker
            del self.learner
    ...
    def learn(self, learner):
        """The hearer is trained on the meaning-signal pairs."""
